    ...
    return (
        <div className="min-h-screen p-6 md:p-12 lg:p-20 max-w-[1600px] mx-auto w-full pt-28">
            <div className="flex flex-col gap-4 mb-12">
                <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 pb-2">
                    {t('title')}
                </h1>
