            ...
            <div className="max-w-6xl mx-auto space-y-16">
                    ...
                    {steps.map((step, index) => (
                        <div key={index} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 group`}>
                            ...
                            <div className="w-full lg:w-1/2 relative">
                                <div className={`absolute -inset-4 bg-gradient-to-br ${step.color} rounded-3xl blur-2xl opacity-20 group-hover:opacity-30 transition duration-700`}></div>
                                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-gray-900 aspect-video group-hover:scale-[1.02] transition duration-500">
                                    <Image
                                        src={step.image}
                            ...
                            <div className="w-full lg:w-1/2 space-y-6">
                                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg shadow-${step.color}/20`}>
                                    {step.icon}
                                </div>
                                ...
                                <div className="pt-4">
                                    {step.action.internal ? (
                                        <Link
                                            ...
                                            className="px-6 py-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium inline-flex items-center gap-2 transition-all group-hover:border-purple-500/50"
                                        >
                                            {step.action.label}
                                            <ArrowRight size={18} />
                                        </Link>
                ...
                <div className="text-center pt-12 border-t border-white/10">
                    <p className="text-gray-500 text-lg">
                        Takıldığın bir yer mi var? <Link href="/dashboard" className="text-purple-400 hover:text-purple-300 underline">Topluluk</Link> bölümünden sorabilirsin.
                    </p>
                </div>
            </div>
        </div>
