...
export default function Navbar({ user }: { user: User | null }) {
    ...
    return (
        <nav className="w-full bg-white/80 dark:bg-black/50 backdrop-blur-md border-b border-gray-200 dark:border-white/10 sticky top-0 z-50 transition-colors duration-300">
